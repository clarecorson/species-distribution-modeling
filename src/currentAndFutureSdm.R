...
#convert to spatial points for the model
...
#this downloads into data folder
...
#lets create a raster stack (stack of layers/variables)
...
# change column names to longitude and latitude for clarity
...
# create a single data frame of presence/absense data by climate variable
...
# just a little bit bigger of a bounding box
...
# take this raster layer and convert it to a data frame so ggplot will run
# first create spatial pixels data frame
raster.spdf <- as(habronattusPredictPlot, "SpatialPixelsDataFrame")

# then create normal data frame
...
# downloading future clinate data 
